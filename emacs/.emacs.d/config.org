...
#+end_src
** Pixel precision mode
When available, scroll nicely through a buffer with pixel-precision-mode. 
#+begin_src emacs-lisp
...
** ob-async
Run code blocks asynchronously.
#+begin_src emacs-lisp
...
** Indent mode
Indent items in org mode according to hierarchy
#+begin_src emacs-lisp
...
** Multiple Cursors
   ...
   #+begin_src emacs-lisp
     ...
     (define-prefix-command 'mc-custom-prefix-map)
     (global-set-key (kbd "C-z") 'mc-custom-prefix-map)
     (define-key mc-custom-prefix-map (kbd ">") 'mc/mark-next-like-this)
     (define-key mc-custom-prefix-map (kbd "<") 'mc/mark-previous-like-this)
     (define-key mc-custom-prefix-map (kbd "C-<") 'mc/mark-all-like-this)
#+end_src
** undo tree
#+begin_src emacs-lisp
